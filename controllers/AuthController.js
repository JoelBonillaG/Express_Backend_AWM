...
class AuthController {
  ...
  async googleCallback(req, res, next) {
    try {
      ...
      const redirectUrl = `/auth/oauth/success?accessToken=${encodeURIComponent(
        accessToken
      )}&refreshToken=${encodeURIComponent(refreshToken.token)}`;
  ...
  oauthSuccess(req, res) {
    ...
    // Si hay tokens, mostrar página EJS, sino JSON
